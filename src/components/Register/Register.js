...
class Register extends React.Component {
  ...
  render() {
  	return(
  		<article className="br3 ba bw2 b--black-10 mv4 w-100 w-50-m w-25-l mw6 shadow-5 center">
                ...
                />
      			...
      			<div className="">
      				<input onClick={this.onSubmitSignIn} 
      					className="b ph3 pv2 input-reset ba b--black bg-transparent grow pointer f4 dib" type="submit" value="Register" />
      			</div>
    			</div>
  		</main>
  		</article>
